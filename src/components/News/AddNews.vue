        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Add News Item</li>
                    </ol>
                </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Provide News Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form @submit.prevent="ValidateInputs">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="formdata.ptitle" class="form-control" required>
                                    </div>
                                    </div>
                                    <div class="col-sm-6">
                                    <!-- text input -->
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled v-model="getSlug" class="form-control" required>
                                    </div>
                                    </div>
                                </div>
                                <div class="row">
    ...
    methods: {
        ...
        saveNewsItem: function(){
            ...
            .then(res => {
                ...
                this.postStatus.text = "News Item saved succesfully"

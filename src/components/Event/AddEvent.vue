                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Provide Event Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form @submit.prevent="ValidateInputs">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="formdata.ptitle" class="form-control" required placeholder="Enter Event type">
                                    </div>
                                    </div>
                                    <div class="col-sm-6">
                                    <!-- text input -->
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled v-model="getSlug" class="form-control" required placeholder="Enter Event location">
                                    </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label>Event Banner</label>
                                        <input type="text" disabled :value="formdata.pbanner" disabled class="form-control">
                                    </div>
                                    </div>
                                    <div class="col-sm-6">
                                    <!-- textarea -->
                                    <div class="form-group">
                                        ...
                                        <input type="date" v-model="formdata.pdate" required class="form-control"  placeholder="https://image-url.ext">
                                    </div>
                                    </div>
                                    <div class="col-sm-12">
                                    <!-- textarea -->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <div class="alert alert-danger alert-dismissible" id="postStatusIsError" style="display: none;">
                                ...
                                {{postStatus.text}}
                                <p>Server responded with status code of {{postStatus.statusCode}}</p>
...
export default {
    ...
    methods: {
        ...
        ValidateInputs: function(){
            if (!this.formdata.ptitle || !this.formdata.pdate) {
        ...
        saveEventData: function(){
            ...
            this.formdata.ptype = 2
            this.formdata.powner = 1
            window.$('button#submitBtn').attr('disabled', true).text('Submitting Event...')
            window.axios.post(`${this.baseUrl}/public/create`, this.formdata)
            .then(res => {
                console.log(res)
                window.$('div#status').fadeIn()
                window.$('div#postStatusIsSuccess').show()
                window.$('button#submitBtn').attr('disabled', false).text('Submit')
                this.postStatus.text = "Event saved succesfully"
